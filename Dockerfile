# Copied from librespot github.
# I have removed anything relating to the three other architectures.
# And added the third set of apt packages (needed for evdev-rs I think).
...
RUN apt-get install -y dh-autoreconf python3
...
ENV CARGO_TARGET_DIR /george/docker-build
ENV CARGO_HOME /george/docker-build/cache
